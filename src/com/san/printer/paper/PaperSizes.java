...
public class PaperSizes {
    ...
    private static void addCustomPaperSizes() {
      ...
      //String printDescription;
        ...
        /**
         * //A4 (border) printDescription="A4"; paper = new Paper();
         * paper.setSize(595, 842); paper.setImageableArea(43, 43, 509, 756);
         * paperDefinitions.put(printDescription,paper);
         * paperList.add(printDescription);
               /*
         */
        /**
         * //A4 (borderless) printDescription="A4 (borderless)"; paper = new
         * Paper(); paper.setSize(595, 842); paper.setImageableArea(0, 0, 595,
         * 842); paperDefinitions.put(printDescription,paper);
         * paperList.add(printDescription);
         *
         **/
        /**
         * //A5 printDescription="A5"; paper = new Paper(); paper.setSize(420,
         * 595); paper.setImageableArea(43,43,334,509);
         * paperDefinitions.put(printDescription,paper);
         * paperList.add(printDescription);
         *
         * //Added for Adobe printDescription="US Letter (8.5 x 11)"; paper =
         * new Paper(); paper.setSize(612, 792);
    ...
    /*
         */
        /**
         * //custom printDescription="Custom 2.9cm x 8.9cm"; int customW=(int)
         * (29*2.83); int customH=(int) (89*2.83); //2.83 is scaling factor to
         * convert mm to pixels paper = new Paper(); paper.setSize(customW,
         * customH); paper.setImageableArea(0,0,customW,customH); //MUST BE SET
         * ALSO paperDefinitions.put(printDescription,paper);
         * paperList.add(printDescription);
         */
        /**
         * kept in but commented out for general usage //architectural D
         * (1728x2592) printDescription="Architectural D"; paper = new Paper();
         * paper.setSize(1728, 2592); paper.setImageableArea(25,25,1703,2567);
         * paperDefinitions.put(printDescription,paper);
         * paperList.add(printDescription);
    /*
         */
